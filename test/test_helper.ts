...
export function createEnum(runner?: Runner.Runner): Symbol.Enum {
  ...
  return new Symbol.Enum(runner, 'FooType',
      ['awesome', '@default FooType.Bar', '@type Enum'], ['App', 'Type'],
      [
        new Symbol.EnumMember(runner, 'Bar', [''], 0),
        new Symbol.EnumMember(runner, 'Baz', [''], 1)
      ]);
}
